...
10. TWA-001 已完成技术冻结、用户最终确认与国际化 / 双市场版本架构补充；下一步仍是继续 `yuan-frontend` 移动端优先 App Shell / 首页 / 工作台静态 mock 实现，且必须预留 locale-aware / market-aware 结构；仍禁止真实 API、数据库 schema、短信、生图、试卷、支付和 secret。
